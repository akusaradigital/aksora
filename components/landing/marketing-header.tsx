    ...
    <nav className="fixed left-0 right-0 top-0 z-50 border-b border-slate-200 bg-white" aria-label="Main navigation">
      <div className="mx-auto flex h-14 max-w-6xl items-center justify-between px-5">
        ...
        <div className="hidden items-center gap-6 sm:flex">
          <Link href="/#features" className="text-[12px] font-medium text-slate-500 transition-colors hover:text-slate-950">Features</Link>
          <Link href="/#pricing" className="text-[12px] font-medium text-slate-500 transition-colors hover:text-slate-950">Pricing</Link>
          <Link href="/#roi" className="text-[12px] font-medium text-slate-500 transition-colors hover:text-slate-950">Estimate</Link>
        </div>
